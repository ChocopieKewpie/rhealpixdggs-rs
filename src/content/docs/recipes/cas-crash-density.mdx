...
description: Aggregate public Wellington crash points into equal-area rHEALPix cells.
---
...
<div class="rhp-map-pair">
  <figure>
    <a href="/rhealpixdggs-rs/images/wellington-cas-2024-r8.png">
      <img src="/rhealpixdggs-rs/images/wellington-cas-2024-r8.png" alt="Wellington CAS crash density in resolution-8 rHEALPix cells" />
    </a>
    <figcaption><strong>Resolution 8.</strong> 399 occupied cells · approximately 1.975 km² each</figcaption>
  </figure>
  <figure>
    <a href="/rhealpixdggs-rs/images/wellington-cas-2024-r9.png">
      <img src="/rhealpixdggs-rs/images/wellington-cas-2024-r9.png" alt="Wellington CAS crash density in resolution-9 rHEALPix cells" />
    </a>
    <figcaption><strong>Resolution 9.</strong> 1,012 occupied cells · approximately 0.219 km² each</figcaption>
  </figure>
</div>
