...
description: Start indexing and traversing rHEALPix cells from native Rust.
---
...
:::caution[Rust coordinate order]
Rust geographic methods use `(longitude, latitude)` in degrees. This is the
opposite of the H3-style Python facade.
:::

For the complete surface, see the [Rust API reference](/rhealpixdggs-rs/api/rust/) or run:
