---
title: Indexing
description: Convert coordinates to cells and recover cell locations.
---
...
[NumPy bulk function](/rhealpixdggs-rs/api/numpy/#latlngs_to_cells), which returns `uint64` IDs
