---
title: rhealpixdggs-py compatibility facade
description: Use the upstream-compatible object-oriented Python API.
---
...
[Upstream compatibility](/rhealpixdggs-rs/engineering/upstream-compatibility/).
