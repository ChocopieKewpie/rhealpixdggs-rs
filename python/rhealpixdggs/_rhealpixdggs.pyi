...
def cell_equals(left: str, right: str) -> bool: ...
def cell_within(left: str, right: str) -> bool: ...
def cell_contains(left: str, right: str) -> bool: ...
def cell_covers(left: str, right: str) -> bool: ...
def cell_covered_by(left: str, right: str) -> bool: ...
def cell_touches(left: str, right: str) -> bool: ...
def cell_disjoint(left: str, right: str) -> bool: ...
def cell_intersects(left: str, right: str) -> bool: ...
def cell_crosses(left: str, right: str) -> bool: ...
def cell_overlaps(left: str, right: str) -> bool: ...
def grid_disk(origin: str, k: int) -> list[str]: ...
def grid_ring(origin: str, k: int) -> list[str]: ...
